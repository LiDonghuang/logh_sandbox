...
## Version 1.2 (Lightweight Edition)

Status: Active
Authority: Governance Core (App Layer)
Scope: All Engineering Phases

This version supersedes operational usage of v1.1 while remaining fully compatible with it.
...
The protocol ensures that engineering exploration remains fast while governance preserves structural integrity.
...
Governance review is required only when proposals involve:
...
# VI. Mandatory Engineering Report Format
...
Engineering must treat these as **interpretive constraints**, not editable specifications.

Any modification requires Governance approval.

---

# VIII. Context Minimization Rule
...
Governance intervention occurs only at **integration gates**.

---

# X. Phase Escalation Trigger
...
Engineering must halt structural changes and request governance review.

---

# XI. Operational Principle
...
Engineering exploration should remain rapid.
...
End of Protocol
Sandbox Cross-Thread Collaboration Protocol v1.2
