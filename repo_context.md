...
- `test_run/test_run_v1_0.testonly.settings.json`
  ...
  - active PR #6 branch-only movement seams currently include bounded `v4a` transition-movement / terminal controls used only in `test_run`; some temporary local `20260404` smoothing knobs have already been retired and should not be treated as stable surface
