                    ...
                    for attack_range in ATTACK_RANGES:
                        ...
                        runtime_cfg = SimulationRuntimeConfig(
                            ...
                            movement=SimulationMovementConfig(
                                ...
                                pre_tl_target_substrate=substrate_label or PRE_TL_TARGET_SUBSTRATE_NEAREST5,
                            ...
                            boundary=SimulationBoundaryConfig(
                                enabled=bool(get_runtime_setting(settings, "boundary_enabled", True)),
                                hard_enabled=bool(get_runtime_setting(settings, "boundary_hard_enabled", False)),
                                soft_strength=float(get_runtime_setting(settings, "boundary_soft_strength", 0.1)),
                            ),
                        )
